...
Create a scatter plot of daily average temperature in Eindhoven against Schiphol using the wide-format climate data.
Color the points based on whether the average temperature in Eindhoven on that day was above or below 10°C:

Use red for days when Eindhoven's temperature was above 10°C,
